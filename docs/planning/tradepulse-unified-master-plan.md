...
**文档状态：** 33/38 个任务已完成；A4-03 与 Issue #81 已完成开发和本地验收，待 PR、CI 与生产发布；发布后更新为 34/38，下一项 A4-04
**版本：** v2.0
**日期：** 2026-07-25
...
| 阶段 4：经理与反馈 | 进行中 | `main` @ `2989bce`；功能分支 `codex/issue-81-a4-03-governance` | A4-01/A4-02 已发布；A4-03 五类反馈、版本指标、影子评估、人工批准和回滚，以及 Issue #81 Qwen 在线/Batch 通道已完成开发与本地验收。治理专项 12/12、完整回归 530/530、JS 语法/diff、桌面与 390px 浏览器通过；证据见 `docs/evidence/a4-03-ai-governance.md` 和 `docs/evidence/issue-81-qwen-online-batch.md`。尚待 PR/CI、生产备份、部署和 smoke | `previous` + Qwen 在线/Batch 独立开关 | A4-03 发布后更新为 34/38；下一步 A4-04；禁止模型在线自我发布 |
| 阶段 5：生产试运行 | 未开始 | 待填写 | 待填写 | previous release + flags | 分批开放 |

当前总进度：38 个计划任务中已完成 33 个，剩余 5 个。A4-03 与 Issue #81 已完成开发、
完整回归 530/530 及桌面/390px 本地验收，但尚未合并和发布，不提前计入已完成任务。
PR/CI、生产备份、`quick_check`、回滚确认、部署和 smoke 通过后更新为 34/38、剩余 4 项；
下一项为 A4-04，本轮完成发布后停止。
