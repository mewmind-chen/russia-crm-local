...
**文档状态：** 34/38 个任务已完成；A4-03 与 Issue #81 已完成开发、CI 和生产发布；下一项 A4-04
**版本：** v2.0
**日期：** 2026-07-25
...
| 阶段 4：经理与反馈 | 进行中 | `main`/生产 `current` @ `296edd268162`；`previous` @ `a1e7043a2165` | A4-01/A4-02/A4-03 已发布；A4-03 完成五类反馈、版本指标、影子评估、人工批准和回滚，Issue #81 完成 Qwen 在线/Batch。治理专项 12/12、完整回归 531/531、GitHub CI、桌面/390px、backup/quick_check、local/public health、真实 Qwen smoke 和 Batch 禁用态通过；PR #84/#85 已合并，Issue #81 已关闭；证据见 `docs/evidence/a4-03-ai-governance.md` 和 `docs/evidence/issue-81-qwen-online-batch.md` | `previous` + Qwen 在线/Batch 独立开关；Batch 运行时待价格/汇率 | A4-03 已完成；下一步 A4-04；禁止模型在线自我发布 |
| 阶段 5：生产试运行 | 未开始 | 待填写 | 待填写 | previous release + flags | 分批开放 |

当前总进度：38 个计划任务中已完成 34 个，剩余 4 个。A4-03 与 Issue #81 已完成开发、
