...
| FR-01 | 已发布 | 模块化前端首轮双外壳发布：统一客户详情七标签、AI 五层业务呈现、三角色 AI 权限边界、旧深链兼容和移动无障碍完成；实现提交 `660345a`，PR #90 合并并发布 `main`/生产 `9aaa8b38c85d93eaa5f1a9244538dd670ea065e6`；聚焦 31/31、完整回归 615/615、35 项能力零遗漏、PR/main CI、JavaScript 语法/diff、管理员/经理/销售独立库及生产桌面/390px未登录 smoke 通过；自动备份和活动库 `quick_check=ok`，local/public health 为目标 SHA；`CRM_UX_REDESIGN_ENABLED=true`，回滚点为 `79800f529d1d` 或关闭前端开关；证据见 `docs/evidence/frontend-modular-refactor-stage-gate.md`；旧外壳稳定观察后另行退役，不改变 35/38 和下一项 R5-01 |
