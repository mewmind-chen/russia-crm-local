...
> 自动生成于 `2026-09-01 09:45:02`；运行 `npm run board` 手动重新生成，每个切片收尾自动更新。
...
| HEAD | `bf5b40f`（相对 origin/main ahead 288） |
| 工作区 | 有未提交改动 |
| 全量测试 | `node --test` 2072/2072 |
| 核心测试 | `npm test` 1710/1710 |
| sales_crm.js | 12945 行 |
| lib/domains | 44 个文件，生产接线 41 个 |
| 最近会话 | `2026-09-01-list-widget-correction-history.md` |
