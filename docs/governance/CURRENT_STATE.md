...
| 重构后/开发中 | `/Users/ylf/Desktop/projects/tradepulse-refactor/after` | `codex/frontend-widget-pilot@6674cab`，业务提交 `e76ae96` 与治理看板已提交；工作区干净 | 当前唯一重构开发入口 |
...
- `npm test`：全量 core `1677/1677` 通过。
- `node --test`：全量 `2038/2038` 通过。
