...
| 重构后/开发中 | `/Users/ylf/Desktop/projects/tradepulse-refactor/after` | `codex/frontend-widget-pilot@41a722e`，干净 | 当前唯一重构开发入口 |

- 远程：`https://github.com/mewmind-chen/russia-crm-local.git`
- 当前 `origin/main`：`57c4c42a89e7730545b726b29fd932c5bfb20574`
- 当前重构提交：`41a722e`（阶段 E 次片：profile-facts 抽为自包含 UMD widget）
...
- `npm test`：全量 core `1626/1626` 通过。
- `node --test`：全量 `1987/1987` 通过。
