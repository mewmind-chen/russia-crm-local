...
- 当前重构提交：`2f9c2d5`（阶段 E：customerProfile widget 视图补下一步状态条）
...
- `npm test`：全量 core `1662/1662` 通过。
- `node --test`：全量 `2023/2023` 通过。
...
本轮 core 1659/1659、全量 2020/2020 全绿。剩余：其余 widget 化（身份/业务画像/
