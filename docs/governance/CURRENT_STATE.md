...
- 当前验证（2026-09-01）：列表 widget/访问控制/API 定向 `62/62`，widget/抽屉/iframe + Issue 171/287 定向全部通过；`npm test`：core `1718/1718`，`node --test`：全量 `2080/2080`；本轮业务切片已通过 `node --check`、`git diff --check`。治理权威门禁与 AI 边界门禁已复跑通过。
