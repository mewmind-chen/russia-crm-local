...
test('statistics release uses a fresh production cache token', () => {
  assert.match(html, /sales-assets\/app\.js\?v=20260814-issue293-permission-group-editor/);
  assert.match(html, /sales-assets\/app\.css\?v=20260814-issue293-permission-group-editor/);
});
