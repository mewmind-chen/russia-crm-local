...
test('plan UI uses basis-aware conversion, AI normalization, and the current JS cache key', () => {
  ...
  assert.match(html, /sales-assets\/app\.js\?v=20260814-issue291-browser-regressions/);
  assert.match(html, /sales-assets\/app\.css\?v=20260814-issue291-browser-regressions/);
});
