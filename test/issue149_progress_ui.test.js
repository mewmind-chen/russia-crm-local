...
test('Issue 149 assets are cache-busted together', () => {
  assert.match(html, /sales-assets\/app\.css\?v=20260821-issue336-customer-stars-v1/);
  assert.match(html, /sales-assets\/app\.js\?v=20260821-issue336-customer-stars-v1/);
});
