...
test('mismatch profile assets use the current production cache token', () => {
  assert.match(shell, /sales-assets\/app\.css\?v=20260821-issue335-action-command-v1/);
  assert.match(shell, /sales-assets\/app\.js\?v=20260821-issue335-action-command-v1/);
});
