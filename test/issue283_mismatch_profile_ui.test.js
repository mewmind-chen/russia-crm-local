...
test('mismatch profile assets use the current production cache token', () => {
  assert.match(shell, /sales-assets\/app\.css\?v=20260821-issue333-stat-drilldown-v3/);
  assert.match(shell, /sales-assets\/app\.js\?v=20260821-issue333-stat-drilldown-v3/);
});
