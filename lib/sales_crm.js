...
function mismatchAccountDto(value, user, parsed, account, options = {}) {
  ...
  return {
    ...
    customer: {
      ...
      products: String(account.product_focus || ''),
      description: String(account.master_description || ''),
    },
    recycle: baseProfile.recycle,
    profile: {
  ...
  try {
    ...
    if (!account) {
      ...
      throw exists
        ...
        : recycleError(404, '不对口记录不存在', 'MISMATCH_RECORD_NOT_FOUND');
    }
