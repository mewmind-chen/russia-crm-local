...
const ROLE_PERMISSIONS = {
  ...
  manager: {
    ...
    manage_activity_corrections: true, record_quote: true, record_order: true,
  ...
  sales: {
    ...
    manage_activity_corrections: false, record_quote: true, record_order: true,
