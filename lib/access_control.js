...
const LEGACY_ROUTE_POLICIES = Object.freeze({
  ...
  'GET /report': { permissions: ['view_recon'] },
...
const LEGACY_ACTION_POLICIES = Object.freeze({
  ...
  'prospect-agent': {
    createTask: { permissions: ['use_prospect_agent', 'view_all_customers', 'view_contacts'] },
    runTask: { permissions: ['use_prospect_agent', 'view_all_customers', 'view_contacts'] },
    rerunTask: { permissions: ['use_prospect_agent', 'view_all_customers', 'view_contacts'] },
    promoteCandidate: { permissions: ['use_prospect_agent', 'view_all_customers', 'view_contacts', 'edit_customer'] },
  },
});
...
function permissionsFor(user) {
  ...
  const overrides = normalizePermissions(json(user?.permissions_json, {}));
