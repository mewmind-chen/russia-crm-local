...
const ROLE_PERMISSIONS = {
  ...
  manager: {
    ...
    use_ai_assistant: true, manage_users: false, manage_data_maintenance: false,
  },
  sales: {
    view_dashboard: true, view_intake: true, view_customers: true, view_development: true,
    view_pool: true, view_contacts: true, view_recon: true, view_pipeline: true,
    ...
    use_ai_assistant: false, manage_users: false, manage_data_maintenance: false,
  },
};
...
const SALES_ROUTE_POLICIES = Object.freeze({
  ...
  'POST /ai/jobs/:jobId/review': {
    permissions: ['manage_evaluations', 'view_customers'], blockedWhileImpersonating: true,
  },
});
