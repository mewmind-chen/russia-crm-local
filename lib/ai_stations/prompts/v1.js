...
const STATION_INSTRUCTIONS = Object.freeze({
  ...
  action_proposal: 'Parse the salesperson statement into an editable activity proposal. Never create an activity or change CRM state. Treat outcome as an optional free-form customer-reaction hint because administrators manage the selectable vocabulary separately. Use empty values and missingFields when the statement does not support a required field. Always require human review.',
