...
async function currentCustomerAssistantAnswer(message, contextPayload = {}, history = [], sessionId = '', sessionEngine = '') {
...
async function answerAssistantQuestionScoped(payload = {}) {
  ...
  if (kind === 'current_customer') {
    const current = await currentCustomerAssistantAnswer(retrievalMessage, contextPayload, history, sessionId, sessionEngine);
